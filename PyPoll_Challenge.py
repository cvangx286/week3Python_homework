...
#         # 6c: Calculate the percentage of votes for the county.
        ...
        county_results = (f"{county_name}: {county_vote_percentage:.1f}% ({votes2:,})\n")
...
#          # 6f: Write an if statement to determine the winning county and get its vote count.
        if(votes2 > largest_county_count) and (county_vote_percentage > largest_county_percentage):
            largest_county_count = votes2
...
# #     # 8: Save the county with the largest turnout to a text file.
    txt_file.write('Largest County Turnout')
